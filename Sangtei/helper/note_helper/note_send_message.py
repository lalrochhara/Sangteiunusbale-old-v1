...
from Sangtei.database.notes_mongo import GetNote
from Sangtei.helper.button_gen import button_markdown_parser
from Sangtei.helper.note_helper.note_fillings import NoteFillings
from Sangtei.helper.note_helper.note_misc_helper import preview_text_replace
...
async def SendNoteMessage(message: Message, note_name: str, from_chat_id: int):
    ...
    if (
        ...
        await SangteiCli.send_animation(
            chat_id=chat_id,
            animation=content,
            reply_to_message_id=message_id,
            reply_markup=reply_markup
        ...
        await SangteiCli.send_video_note(
            chat_id=chat_id,
            video_note=content,
            reply_to_message_id=message_id,
            reply_markup=reply_markup
