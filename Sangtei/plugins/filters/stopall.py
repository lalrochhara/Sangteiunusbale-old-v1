...
from Sangtei.database.filters_mongo import stop_all_db
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import isUserCreator


@SangteiCli.on_message(custom_filter.command('stopall'))
...
@SangteiCli.on_callback_query(filters.create(lambda _, __, query: 'filters_' in query.data))
async def stopall_callback(client: SangteiCli, callback_query: CallbackQuery):
