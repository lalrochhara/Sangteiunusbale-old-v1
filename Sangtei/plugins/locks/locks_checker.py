...
from Sangtei.database.locks_mongo import get_allowlist, get_locks, lockwarns_db
from Sangtei.helper.chat_status import check_bot, isUserAdmin
from Sangtei.plugins.warnings.warn import warn
from urlextract import URLExtract

from . import lock_map


@SangteiCli.on_message(filters.all & (filters.group | filters.channel) | filters.new_chat_members, group=4)
    ...
    if 4 in LOCKS_LIST:
        if message.new_chat_members:
            ...
            for new_member in message.new_chat_members:
                ...
                await SangteiCli.kick_chat_member(
                    chat_id,
                    bot_id,
        ...
        if (
            ...
            if message.reply_to_message.forward_from_chat.type == 'channel':
                ...
                if linked_chat == channel_id:
                    chat_member = await SangteiCli.get_chat_member(
                        chat_id=chat_id,
                        user_id=from_user
                    )
