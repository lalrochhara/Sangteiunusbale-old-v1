...
from Sangtei.database.locks_mongo import lockwarns_db, set_lockwarn_db
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import check_user

LOCKWARN_TRUE = ['on', 'yes']
LOCKWARN_FALSE = ['off', 'no']

@SangteiCli.on_message(custom_filter.command(commands=('lockwarns')))
