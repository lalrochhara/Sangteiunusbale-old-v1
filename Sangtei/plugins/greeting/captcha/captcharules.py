...
from Sangtei.database.welcome_mongo import isRuleCaptcha, setRuleCaptcha
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import isUserAdmin

CAPTCHARULE_TRUE = ['on', 'aw']
CAPTCHARULE_FALSE = ['off', 'aih']

@SangteiCli.on_message(custom_filter.command('captcharules'))
