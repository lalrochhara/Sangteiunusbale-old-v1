...
from Sangtei.database.welcome_mongo import isReCaptcha, setReCaptcha
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import isUserAdmin

RECAPTCHA_TRUE = ['on', 'aw']
RECAPTCHA_FALSE = ['off', 'aih']

@SangteiCli.on_message(custom_filter.command('recaptcha'))
