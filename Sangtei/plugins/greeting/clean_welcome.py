...
from Sangtei.helper.chat_status import (
    CheckAdmins
    )
...
CLEAN_WELCOME_TRUE = ['on', 'aw']
CLEAN_WELCOME_FALSE = ['off', 'aih']

@SangteiCli.on_message(custom_filter.command(commands=('cleanwelcome')))
@anonadmin_checker
