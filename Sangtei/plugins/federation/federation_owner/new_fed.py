...
from Sangtei import LOG_CHANNEL, SangteiCli, TELEGRAM_SERVICES_IDs
from Sangtei.database.federation_mongo import new_fed_db
from Sangtei.helper import custom_filter


@SangteiCli.on_message(custom_filter.command(commands=('newfed')))
