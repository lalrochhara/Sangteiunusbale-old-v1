...
from Sangtei.database.blocklists_mongo import get_blocklist, unblocklistall_db
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import isUserCreator
from Sangtei.helper.get_data import get_text_reason


@SangteiCli.on_message(custom_filter.command(commands=['unblocklistall', 'unblacklistall']))
...
@SangteiCli.on_callback_query(filters.create(lambda _, __, query: 'blocklist_' in query.data))
async def removeblocklistall_callback(client: SangteiCli, callback_query: CallbackQuery):
