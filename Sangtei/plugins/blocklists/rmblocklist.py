...
from Sangtei.database.blocklists_mongo import get_blocklist, rmblocklist_db
...
@SangteiCli.on_message(custom_filter.command(commands=['rmblocklist', 'rmblacklist']))
