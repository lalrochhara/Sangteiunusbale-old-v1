...
from Sangtei.plugins.connection.connect import connectRedirect
from Sangtei.plugins.greeting.captcha.button_captcha import \
    buttonCaptchaRedirect
from Sangtei.plugins.greeting.captcha.text_captcha import textCaptchaRedirect
from Sangtei.plugins.notes.private_notes import note_redirect
from Sangtei.plugins.rules.rules import rulesRedirect
# from Sangtei.plugins.help.help import redirectHelp

START_TEXT = (
    "Konnichiwa {mention}! I am Sangtei - the first telegram group management bot to be built in `Pyrogram` with the support of `MongoDB`, this also means I am faster than others in terms of processing and giving outputs. I have a large set of modular features to offer that'll help you manage your chats in an efficient way. \n\n"
    ...
    "Updates Channel: **@SangteiUpdates**\n"
    "Support Chat: **@SangteiSupportChat**"
)

@SangteiCli.on_message(custom_filter.command(commands=('start')))
