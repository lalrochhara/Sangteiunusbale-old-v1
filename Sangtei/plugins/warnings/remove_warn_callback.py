...
from Sangtei.database.warnings_mongo import remove_warn
from Sangtei.helper.chat_status import isUserAdmin


@SangteiCli.on_callback_query(filters.create(lambda _, __, query: 'warn_' in query.data))
async def warn_remove_callback(client: SangteiCli, callback_query: CallbackQuery):
