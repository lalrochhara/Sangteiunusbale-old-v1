...
from Sangtei.database.notes_mongo import GetNote, is_pnote_on, isNoteExist
from Sangtei.helper import custom_filter
from Sangtei.helper.note_helper.note_misc_helper import \
...
@SangteiCli.on_message(custom_filter.command(commands=('get')))
...
@SangteiCli.on_message(filters.regex(pattern=(r"^#[^\s]+")))
