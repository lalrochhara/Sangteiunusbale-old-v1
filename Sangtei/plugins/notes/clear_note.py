...
@SangteiCli.on_message(custom_filter.command(commands=('clearall')))
...
@SangteiCli.on_callback_query(filters.create(lambda _, __, query: 'clearallnotes_' in query.data))
async def ClearAllCallback(client: SangteiCli, callback_query: CallbackQuery):
