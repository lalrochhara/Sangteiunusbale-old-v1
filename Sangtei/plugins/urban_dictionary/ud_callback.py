...
@SangteiCli.on_callback_query(filters.create(lambda _, __, query: 'pagination_keyboard#' in query.data))
async def ud_callback(client: SangteiCli, callback_query: CallbackQuery):
    ...
    await SangteiCli.edit_message_text(
        chat_id=chat_id,
