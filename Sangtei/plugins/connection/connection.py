...
from Sangtei.helper.chat_status import isUserAdmin, isUserBanned
from Sangtei.plugins.connection.connect import connect_button


@SangteiCli.on_message(custom_filter.command(commands=('connection')))
