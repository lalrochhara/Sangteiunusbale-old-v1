...
from Sangtei.database.log_channels_mongo import set_log_db
...
@SangteiCli.on_message(custom_filter.command(commands=('setlog')))
@anonadmin_checker
async def set_log(client, message):
    ...
    try:
        GetChannelData = await SangteiCli.get_chat_member(
