...
from Sangtei.database.antiflood_mongo import setflood_db
from Sangtei.helper import custom_filter
from Sangtei.helper.chat_status import CheckAllAdminsStuffs, isBotAdmin


@SangteiCli.on_message(custom_filter.command(commands=('setflood')))
