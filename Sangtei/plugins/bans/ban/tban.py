...
from Sangtei.helper.chat_status import CheckAllAdminsStuffs, can_restrict_member
from Sangtei.helper.convert import convert_time
from Sangtei.helper.get_user import get_text, get_user_id
from Sangtei.helper.time_checker import get_time, time_string_helper


@SangteiCli.on_message(custom_filter.command(commands=('tban')))
@anonadmin_checker
