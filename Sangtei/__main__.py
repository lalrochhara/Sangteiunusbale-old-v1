...
from Sangtei import SangteiCli, scheduler
...
for mode in ALL_MODULES: 
    ...
    imported_module = importlib.import_module('Sangtei' + module)
    ...
    if not imported_module.__mod_name__.lower() in IMPORTED:
        ...
        raise Exception("Modules in ang hming in ang chiah a neih theih loh! pakhat tal thlak rawh")
